      ...
      <span className="navbar-text mt-2">
        ...
        <div>
          ...
          <div className="container border border-primary border-2 rounded mb-5 mt-5" key={proposal._id}>
              ...
              <h2 className="mt-4 ms-3 text-nowrap d-flex">Sent By: <p className="ms-2 text-secondary text-capitalize"> {proposal.employee.name} {proposal.employee.lastname}</p></h2>
              ...
              <h6 className="mt-2 ms-3 d-flex text-nowrap">About <p className="ms-1 text-capitalize">({proposal.employee.name})</p> <p className="ms-2 d-flex text-wrap text-success"> <span>{proposal.description}</span></p></h6>
          </div>
